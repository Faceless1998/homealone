...
const resources = {
  ...
  ge: {
    translation: {
      "Why You Should Trust Us?" : "რატომ უნდა გვენდობოდეთ?" ,
      ...
      "prodiskr12" : "სისტემის მართვა სხვადასხვა სცენარის მიხედვით" ,
      "prodiskr13" : "მარტივი და მოსახერხებელი ინტერფეისი" ,
      "prodiskr14" : "სისტემის მართვა მობილური აპლიკაციის მეშვეობით" ,
      "prodiskr15" : "ჩართეთ მოწყობილობები დისტანციურად, იგრძენით კომფორტი სახლში მისვლისთანავე" ,
      "Back" : "უკან" ,
      ...
      "Temperature Control" : "ტემპერატურის მართვის ჭკვიანი სისტემა" ,
      "Home Entertaiment" : "ელექტრონული მოწყობილობების ჭკვიანი მართვის სისტემა" ,
      ...
      "Abouttxt1" : "კომპანია \"მარტო სახლში\" სამომხმარებლო ბაზარზე 2019 წლიდან ფუნქციონირებს. კომპანიის მიზანია ცხოვრების ყოველდღიური რუტინის გამატრივება, რომელიც ხორციელდება ჭკვიანი სისტემების ინტერაქციით სამომხმარებლო სივრცეში. შემოთავაზებული ტექნოლოგიის საშუალებით შესაძლებალია სწრაფად და მარტივად შექმნათ ხარისხიანი და იდეალური პირობები სახლისათვის, შეცვალოთ ცხოვრების სტილი, გადადგათ თამამი ნაბიჯი კეთილდღეობისაკენ. კომპანია აქცენტს აკეთებს IOT სისტემების დანერგვაზე, რომელიც მოიცავს: სახლის სრულ ავტომატიზაციას, ენერგო ეფექტურობას, ვენტილაციას, გათბობას, ფარდებისა და წყლის სისტემის მართვას, ჭკვიან აუდიო სისტემებს და კარების ჭკვიან ჩამკეტებს." ,
      "Abouttxt2" : "ჭკვიანი მოწყობილობების მართვა დაფუძნებულია ქსელური ტექნოლოგიების ერთ-ერთ თანამედროვე სტანდარტზე - ZEGBEE, რომელიც უზრუნველყოფს უსაფრთხოების გარანტიას და მონაცემების საიმედო დაცვას." ,
      ...
      "Greenhouse System" : "სასათბურე მეურნეობის მართვის ჭკვიანი სისტემა" ,
  ...
  ru: {
    translation: {
      "Why You Should Trust Us?" : "Почему вы должны доверять нам?" ,
