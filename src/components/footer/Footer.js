                ...
                <p className="footer-call-to-action-description">
                  <ul className="contact-list">
                    ...
                    <li>
                      ...
                      <div className="content1">
                        <a href="mailto:info@homealone.ge">info@homealone.ge</a>
                      </div>
                      <div className="content1">
                        <a href="mailto:ltd.homealone@gmail.com">
                          ltd.homealone@gmail.com
                        </a>
                      </div>
                    </li>
                    ...
                    <li>
                      ...
                      <div className="content1">
                        <a
                          href="https://goo.gl/maps/dyxB9tsXkiRNJAMb7"
                          target="_blank"
                          rel="noreferrer"
                        >
                          {t("addressline")}
